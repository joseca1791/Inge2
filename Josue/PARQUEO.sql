...
CREATE TABLE PARQUEO.PLACAS(
    ID_PLACA        NUMBER NOT NULL PRIMARY KEY,
...
SELECT * FROM PARQUEO.MEDIOSACTUALES;
SELECT * FROM PARQUEO.AUTORIZADOS;
SELECT * FROM PARQUEO.PLACAS;
SELECT * FROM PARQUEO.LUGARES;
SELECT * FROM PARQUEO.USUARIOS;
SELECT * FROM PARQUEO.PLACAS UNION SELECT 
TRUNCATE TABLE PARQUEO.LUGARES;
TRUNCATE TABLE PARQUEO.USUARIOS;



SELECT NUM_PLACA FROM PARQUEO.MEDIO_SACTUALES M JOIN PARQUEO.TIQUETE_ENTRADA T ON M.ID_ENTRADA = T.ID_ENTRADA
WHERE M.ESTADO = 0;
SELECT ID_PLACA FROM PARQUEO.PLACAS;
SELECT DISTINCT ID_PLACA FROM PARQUEO.PLACAS JOIN PARQUEO.MEDIOS_ACTUALES M 
WHERE M.ESTADO = 0;
