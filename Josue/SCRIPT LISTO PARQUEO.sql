...
ALTER TABLE PARQUEO.TIPOS_MEDIOS_TRANSPORTE ADD CONSTRAINT FK_MED_TRANSPORTE FOREIGN KEY (MED_TRANSPORTE) REFERENCES PARQUEO.TIPOS_CLIENTES(ID_CLIENTE);
...
ALTER TABLE PARQUEO.MEDIOS_ACTUALES ADD CONSTRAINT FK_NUMERO_PLACA FOREIGN KEY (NUMERO_PLACA) REFERENCES PARQUEO.PLACAS(ID_PLACA);
...
ALTER TABLE PARQUEO.TIQUETE_ENTRADA ADD CONSTRAINT FK_NUM_PLACA FOREIGN KEY (NUM_PLACA) REFERENCES PARQUEO.PLACAS(ID_PLACA);
...
ALTER TABLE PARQUEO.TIQUETE_SALIDA ADD CONSTRAINT FK_NUMER_PLACA FOREIGN KEY (NUM_PLACA) REFERENCES PARQUEO.PLACAS(ID_PLACA);
