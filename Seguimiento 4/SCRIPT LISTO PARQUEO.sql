...
CREATE OR REPLACE PROCEDURE ACTUALIZAR_USUARIOS (P_ID_USUARIO NUMBER, P_NOMBRE_USUARIO VARCHAR2, P_CLAVE VARCHAR2, P_ESTADO NUMBER) IS
BEGIN    
    UPDATE PARQUEO.USUARIOS SET NOMBRE_USUARIO = P_NOMBRE_USUARIO, CLAVE = P_CLAVE, 
    ESTADO = P_ESTADO WHERE ID_USUARIO = P_ID_USUARIO;
    COMMIT;
END;